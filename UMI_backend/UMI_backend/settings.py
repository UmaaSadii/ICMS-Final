"""
Django settings for UMI_backend project.
...
SECRET_KEY = 'django-insecure-125w!j+j$avuorw++yu)oi365!z0-)tz_daj3ki16^p_)5ancj'
...
if DEBUG:
    ...
    # This is usually added in urls.py, but ensure media files are served properly
